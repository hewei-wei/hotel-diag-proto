...
- Excel 保留为规则维护底稿；本文档第 19 章已将全部诊断规则完整转写，阅读和评审需求时无需再打开 Excel。
...
- 焦点区下方左侧为步骤列表，按检查路径展示全部步骤，示例步骤为“基本信息、酒店政策、酒店设施、门店装修、房型管理、日历房、房价房态管理、预售房型、团购、评价、评价回复、活动管理”，覆盖店铺管理、商品与货架、经营成长、带货与推广四条一级路径；每个步骤以“未诊断”“诊断中”“诊断完成”状态标签展示。
...
| 15 | 活动报名 | 报名页动态必填字段策略及长期忽略未定义 | 遇到新字段只能退回补充 |
