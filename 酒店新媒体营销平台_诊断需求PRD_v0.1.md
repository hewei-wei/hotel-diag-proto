...
- 「团购商品覆盖、价格与名称」不通过时生成一条「团购商品核对任务」，任务详情集中展示本次全部不通过项，按三类分组：
  - 需新增的团购商品：按预售房型分组；一个房型的日常与节假日商品均缺失时，同一分组内展示两个完整新增方案（全部待填字段按 19.10.2 预填）。
  - 价格需修改的商品：每个商品一条核对项，展示商品、关联预售房型、间夜数、携程基准价、对比总价、抖音实际售价、建议售价。
  - 名称需修改的商品：每个商品一条核对项，展示当前名称、名称公式、组成依据、建议名称。
